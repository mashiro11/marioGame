...
namespace GameEngine
{
    ...
    public class SpriteSheet
    {
        ...
        {
            SpriteFrame sf = new SpriteFrame() { currentframepointer = 0, frames = frames };    //cria um novo frame
            
            if (SpriteFrames.ContainsKey(d))    //se dentre os frames ja existe a chave indicando a direção
                SpriteFrames.Remove(d);         //remova aquele frame

            SpriteFrames.Add(d, sf);            //adicione o novo frame
        }
