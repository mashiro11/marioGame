...
namespace GameEngine
{
    ...
    {
        private RenderWindow _window;   //definição da janela

        public RenderWindow Window { get { return this._window; } } //definição de getter para a janela
        public SceneManager SceneManager = new SceneManager();      //cria uma instância do gerenciador de cenas
        
        /** Definição do construtor da classe GameObject
        */
        public GameObject(string Title)     
        {
            ...
            _window.Closed += _window_Closed;   //a direita nas expressões temos ponteiros para funções
