...
namespace GameEngine
{
    public class Level
    {
        ...
        public void LoadMap(string filename, int levelId)
        {
            ...
            time = Convert.ToInt32(tilemapNode.Attributes["time"].InnerText);
            goLeft = tilemapNode.Attributes["goLeft"].InnerText == "true";
        ...
        private void extractTotalLevels(XmlDocument doc)
        {
            while(doc.DocumentElement.SelectSingleNode("/levelData/levels/level[@id='" + totalLevels + "']/tilemap") != null){
                totalLevels++;
            }
        }
